...
export const ReadOnly: React.FC<ReadOnlyProps> = ({ 
  ...
  if (isHorizontal && !labelIcon) {
    return (
      <Comp 
        ...
        {...props}
      >
        <div className="content-stretch flex gap-[var(--spacing-x1)] items-center relative shrink-0" data-name="Label">
          <Typography variant="body-secondary-medium" color="secondary" className="relative shrink-0 whitespace-nowrap">
            {label}:
          </Typography>
        </div>
        <div className="content-stretch flex flex-1 flex-col gap-[var(--spacing-x1)] items-start justify-center min-h-px min-w-px relative shrink-0" data-name="Text">
  ...
  if (isHorizontal && labelIcon) {
    return (
      <Comp 
        ...
        {...props}
      >
        <div className="content-stretch flex gap-[var(--spacing-x1)] items-center relative shrink-0">
  ...
  if (isVertical && labelIcon) {
    return (
      <Comp 
        className={cn(
          "content-stretch flex gap-[var(--spacing-x2)] items-start relative w-[11.4375rem]",
          className
        )}
        {...props}
      >
        ...
        <div className="content-stretch flex flex-1 flex-col gap-[var(--spacing-x2)] items-start min-h-px min-w-px relative shrink-0">
          <div className="content-stretch flex gap-[var(--spacing-x1)] items-center relative shrink-0" data-name="Label">
            <Typography variant="body-secondary-medium" color="secondary" className="relative shrink-0 whitespace-nowrap">
              {label}
            </Typography>
          </div>
          <div className="content-stretch flex flex-col gap-[var(--spacing-x1)] items-start justify-center relative shrink-0 w-full" data-name="Text">
            <Typography variant="body-primary-regular" color="primary" className="relative shrink-0 whitespace-nowrap">
              {value}
            </Typography>
          </div>
  ...
  return (
    <Comp 
      className={cn(
        "content-stretch flex flex-col gap-[var(--spacing-x2)] items-start relative w-[11.4375rem]",
        className
      )}
      {...props}
    >
      ...
      <div className="content-stretch flex flex-col gap-[var(--spacing-x1)] items-start justify-center relative shrink-0 w-[11.4375rem]" data-name="Text">
        <Typography variant="body-primary-regular" color="primary" className="relative shrink-0 whitespace-nowrap">
          {value}
        </Typography>
      </div>
