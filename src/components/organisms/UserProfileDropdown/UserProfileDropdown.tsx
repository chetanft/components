  ...
  return (
    <Comp
      className={cn(
        ...
        'flex flex-col items-center overflow-hidden px-0 py-[var(--spacing-x5)] rounded-[var(--radius-md)] shadow-[var(--shadow-lg)] w-[25rem]',
        className
      )}
      style={baseStyles}
      {...props}
    >
        ...
        <div className="flex gap-[var(--spacing-x5)] items-center w-full">
          ...
          <div className="flex flex-1 flex-col gap-[var(--spacing-x2)] items-start min-w-0">
            <div className="flex items-center justify-between w-full">
              ...
              <div className="bg-[var(--border-secondary)] flex gap-[var(--spacing-x2)] items-center justify-center px-[var(--spacing-x2)] py-[var(--spacing-x0-5)] rounded-[var(--radius-sm)] shrink-0">
      ...
      <div className="box-border content-stretch flex flex-col gap-[var(--spacing-x4)] items-start px-[var(--spacing-x5)] py-0 relative shrink-0 w-full">
        {menuItems.map(({ id, label, iconName }) => (
          <button
            ...
            className="bg-[var(--bg-primary)] box-border content-stretch flex gap-[var(--spacing-x2-5)] items-center p-[var(--spacing-x3)] relative rounded-[var(--radius-md)] shrink-0 w-full hover:bg-[var(--bg-secondary)] transition-colors text-left"
          >
      ...
      <button
        ...
        className="bg-[var(--bg-primary)] box-border content-stretch flex gap-[var(--spacing-x2-5)] items-center px-[var(--spacing-x8)] py-[var(--spacing-x3)] relative rounded-[var(--radius-md)] shrink-0 w-full hover:bg-[var(--bg-secondary)] transition-colors text-left"
      >
