...
export const NavigationLauncher: React.FC<NavigationLauncherProps> = ({
  ...
  const triggerNode =
    ...
    (!hideDefaultTrigger && (
      <button
        ...
        className="rounded-full border border-[var(--border-primary)] p-[var(--spacing-x2-5)] bg-[var(--bg-primary)] hover:bg-[var(--border-secondary)] transition"
      >
  ...
  const overlay = (
    <div
      ...
      onClick={close}
    >
      <div className={cn('flex h-full w-full p-[var(--spacing-x6)] md:p-[var(--spacing-x10)]', alignmentClass)}>
        <div
