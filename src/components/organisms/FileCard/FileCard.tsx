      ...
      >
        ...
        {showStats && (
          <div className="flex items-stretch gap-[var(--spacing-x5)] pl-[calc(var(--spacing-x7)+var(--spacing-x1))]">
            {/* Total */}
            <div className={cn("flex-1 rounded-[var(--radius-md)] p-[var(--spacing-x3)_var(--spacing-x5)] flex flex-col gap-[var(--spacing-x1)] min-h-[4.625rem]", getGlassInnerBg(resolvedGlass, "bg-[var(--bg-secondary)]", "bg-[var(--glass-hover)]"))}>
