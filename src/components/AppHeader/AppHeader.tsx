        ...
        <div style={{
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4.5 16.5c-1.5 1.5-1.5 1.5-.5 3s1.5 1 3-.5L10.5 16M12 15l-3-3m5.5-2.5c.5-.5 1.17-1.17 2-2C18.5 5.5 21 3 21 3s-2.5 2.5-4.5 4.5c-.83.83-1.5 1.5-2 2ZM7 22s0-3 2-5m8.5-11.5L15 8m0 0l-2.5 2.5m2.5-2.5l2.5-2.5" stroke="#434F64" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 8A6 6 0 1 1 18 8c0 7-3 9-6 9s-6-2-6-9ZM15.5 14a2.5 2.5 0 0 1-7 0" stroke="#434F64" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
