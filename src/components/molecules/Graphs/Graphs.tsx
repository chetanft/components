...
export const Graphs: React.FC<GraphsProps> = ({ className = '' }) => {
  return (
    <div className={cn("content-stretch flex flex-col items-start relative size-full", className)} data-name="Type=Bar chart" data-node-id="4026:14389">
      ...
      {/* Legend */}
      <div className="content-stretch flex gap-[var(--spacing-x3)] items-center relative shrink-0 w-full" data-name="Container" data-node-id="4026:14379">
        <div className="content-stretch flex gap-[var(--spacing-x1)] items-center relative shrink-0" data-name="Container" data-node-id="4026:14380">
        ...
        <div className="content-stretch flex gap-[var(--spacing-x1)] items-center relative shrink-0" data-name="Container" data-node-id="4026:14383">
          <div className="flex items-center justify-center relative shrink-0 size-[var(--spacing-x3)]">
        ...
        <div className="content-stretch flex gap-[var(--spacing-x1)] items-center relative shrink-0" data-name="Container" data-node-id="4026:14386">
          <div className="flex items-center justify-center relative shrink-0 size-[var(--spacing-x3)]">
