...
// Generated: 2026-03-08T13:48:17.865Z
...
export const GENERATED_AT = "2026-03-08T13:48:17.865Z";
...
export const SEMANTIC_COLORS: Record<string, { value: string; resolved: string }> = {
  ...
  "bg-primary": {
    "value": "var(--tertiary-0)",
    "resolved": "#ffffff"
  },
  "bg-secondary": {
    "value": "var(--tertiary-100)",
    "resolved": "#f8f8f9"
  },
  "bg-tertiary": {
...
:root {
   ...
   /* Button Colors */
   --button-primary-bg: var(--primary-900);
   --button-primary-text: #ffffff;
   --button-primary-hover-bg: var(--primary-800);
   --button-primary-border: var(--primary-900);
