...
// Generated: 2026-04-01T13:19:00.579Z
...
export const GENERATED_AT = "2026-04-01T13:19:00.579Z";
...
:root {
   ...
   --gradient-blush-peach: linear-gradient(45deg, #ff9a9e 0%, #fad0c4 99%, #fad0c4 100%);
   --gradient-lavender-pink: linear-gradient(to top, #a18cd1 0%, #fbc2eb 100%);
   --gradient-peach-lilac: linear-gradient(to top, #fad0c4 0%, #ffd1ff 100%);
   --gradient-cream-peach: linear-gradient(to right, #ffecd2 0%, #fcb69f 100%);
   --gradient-honey-coral: linear-gradient(120deg, #f6d365 0%, #fda085 100%);
   --gradient-pink-sky: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%);
   --gradient-rose-mist: linear-gradient(to top, #fdcbf1 0%, #fdcbf1 1%, #e6dee9 100%);
   --gradient-mint-sky: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);
   --gradient-neon-mint: linear-gradient(to right, #43e97b 0%, #38f9d7 100%);
   --gradient-sand-lavender: linear-gradient(to top, #ebbba7 0%, #cfc7f8 100%);

   --chart-glow-blur-sm: 8px;
   --chart-glow-blur-md: 16px;
   --chart-glow-blur-lg: 24px;
   --chart-glow-alpha-primary: 0.32;
   --chart-glow-alpha-secondary: 0.18;
...
.dark {
   ...
   --chart-glow-blur-sm: 10px;
   --chart-glow-blur-md: 20px;
   --chart-glow-blur-lg: 28px;
   --chart-glow-alpha-primary: 0.38;
   --chart-glow-alpha-secondary: 0.22;
...
.night {
   ...
   --chart-glow-blur-sm: 10px;
   --chart-glow-blur-md: 20px;
   --chart-glow-blur-lg: 30px;
   --chart-glow-alpha-primary: 0.4;
   --chart-glow-alpha-secondary: 0.24;
...
/* =====================================================
   ORIGIN UI MODE COLORS (Dark only — Zinc-based palette)
   ===================================================== */
.origin-ui {
   /* =====================================================
     BASE COLOR SCALES - ORIGIN UI (Zinc palette)
     ===================================================== */

   /* Primary Scale (9 shades — Zinc inverted for dark surface) */
   --primary-900: #fafafa;   /* zinc-50 */
   --primary-800: #f4f4f5;   /* zinc-100 */
   --primary-700: #e4e4e7;   /* zinc-200 */
   --primary-600: #d4d4d8;   /* zinc-300 */
   --primary-500: #a1a1aa;   /* zinc-400 */
   --primary-400: #71717a;   /* zinc-500 */
   --primary-300: #52525b;   /* zinc-600 */
   --primary-200: #3f3f46;   /* zinc-700 */
   --primary-100: #27272a;   /* zinc-800 */
   ...
   /* Neutral Scale (9 shades — keep functional blues) */
   --neutral-900: #e0f0ff;
   --neutral-800: #cce6ff;
   --neutral-700: #b8dbff;
   --neutral-600: #a3d1ff;
   ...
   /* Positive Scale (9 shades — keep functional greens) */
   --positive-900: #ccffdd;
   --positive-800: #b8f5c8;
   --positive-700: #a3ecb3;
   --positive-600: #8fe29e;
   ...
   /* Warning Scale (9 shades — keep functional oranges) */
   --warning-900: #ffe6cc;
   --warning-800: #ffddb8;
   --warning-700: #ffd4a3;
   --warning-600: #ffcb8f;
   ...
   /* Danger Scale (9 shades — keep functional reds) */
   --danger-900: #ffe3e3;
   --danger-800: #ffd1d1;
   --danger-700: #ffbfbf;
   --danger-600: #ffadad;
   ...
   /* Button Colors - ORIGIN UI */
   --button-primary-bg: #fafafa;
   --button-primary-text: #18181b;
   --button-primary-hover-bg: #d4d4d8;
   --button-primary-border: #fafafa;

   --button-secondary-bg: #27272a;
   --button-secondary-text: #fafafa;
   --button-secondary-hover-bg: #3f3f46;
   --button-secondary-border: #3f3f46;
   --button-secondary-hover-border: #52525b;

   --button-destructive-bg: #7f1d1d;
   --button-destructive-text: #ef4444;
   --button-destructive-hover-bg: #991b1b;
   --button-destructive-border: #7f1d1d;

   --button-text-bg: transparent;
   --button-text-text: #fafafa;
   --button-text-hover-bg: #18181b;
   --button-text-border: transparent;

   /* Badge Colors - ORIGIN UI */
   --badge-normal-bg: #27272a;
   --badge-normal-text: #fafafa;
   --badge-normal-border: #3f3f46;
   --badge-normal-hover-bg: #3f3f46;
   --badge-normal-hover-border: #52525b;
   ...
   /* Badge System Variables - ORIGIN UI */
   --badge-border-radius: 4px;
   --badge-font-size: 12px;
   --badge-font-weight: 500;

   /* Form System Variables - ORIGIN UI */
   --surface: #0a0a0a;
   --surface-dark: #0a0a0a;
   --surface-alt: #18181b;
   --surface-alt-dark: #18181b;
   --surface-hover: #27272a;
   --surface-hover-dark: #27272a;
   --input: #fafafa;
   --input-dark: #fafafa;
   --input-muted: #71717a;
   --input-muted-dark: #71717a;
   --input-disabled: #3f3f46;
   --input-disabled-dark: #3f3f46;
   --placeholder: #71717a;
   ...
   --border-dark: #27272a;
   --border-hover: #52525b;
   --border-hover-dark: #52525b;
   --border-disabled: #18181b;
   --border-disabled-dark: #18181b;
   --border-alt: #27272a;
   --border-alt-dark: #27272a;
   --focus: #52525b;
   --focus-dark: #52525b;
   --focus-ring: #52525b;

   /* Overlay Tokens - ORIGIN UI */
   --overlay-strong: rgba(0, 0, 0, 0.75);
   --overlay-medium: rgba(0, 0, 0, 0.55);
   --overlay-light: rgba(0, 0, 0, 0.35);
   --overlay-control-bg: rgba(255, 255, 255, 0.16);
   --overlay-control-bg-hover: rgba(255, 255, 255, 0.28);
   --overlay-control-divider: rgba(255, 255, 255, 0.35);
   --overlay-control-text: #fafafa;

   /* Glass / Glassmorphism Tokens - ORIGIN UI */
   --glass-blur-sm: 8px;
   --glass-blur: 12px;
   --glass-blur-lg: 18px;
   --glass-blur-liquid: 2px;
   ...
   --glass-bg: rgba(10, 10, 11, 0.45);
   --glass-bg-subtle: rgba(10, 10, 11, 0.30);
   --glass-bg-prominent: rgba(10, 10, 11, 0.60);
   --glass-bg-liquid: rgba(10, 10, 11, 0.10);

   --glass-border: rgba(255, 255, 255, 0.15);
   --glass-border-subtle: rgba(255, 255, 255, 0.08);
   --glass-border-soft: rgba(255, 255, 255, 0.04);
   --glass-border-liquid: rgba(255, 255, 255, 0.30);
   --glass-inner-highlight: rgba(255, 255, 255, 0.10);

   --glass-shadow: 0 14px 40px rgba(0, 0, 0, 0.45), 0 3px 12px rgba(0, 0, 0, 0.30);
   --glass-shadow-lg: 0 18px 50px rgba(0, 0, 0, 0.55), 0 4px 14px rgba(0, 0, 0, 0.32);
   --glass-shadow-liquid: 0 8px 32px rgba(0, 0, 0, 0.40), inset 0 4px 20px rgba(255, 255, 255, 0.05);

   --glass-hover: rgba(255, 255, 255, 0.06);
   --glass-pressed: rgba(255, 255, 255, 0.04);
   --glass-selected: rgba(255, 255, 255, 0.09);

   --glass-radius: 14px;

   /* Switch Component Variables - ORIGIN UI */
   --switch-off-bg: #52525b;
   --switch-on-bg: #3f3f46;
   --switch-disabled-bg: rgba(113, 113, 122, 0.2);
   --switch-thumb-off: #ffffff;
   --switch-thumb-on: #fafafa;
   --switch-disabled-thumb: #18181b;
   --switch-disabled-thumb-on: #3f3f46;

   /* Status Colors - ORIGIN UI */
   --critical-dark: #fecaca;
   --critical: #ef4444;
   --critical-light: #7f1d1d;

   --warning-dark: #fde68a;
   --warning: #f59e0b;
   --warning-light: #78350f;

   --positive-dark: #bbf7d0;
   --positive: #22c55e;
   --positive-light: #14532d;

   --neutral-dark: #bfdbfe;
   --neutral: #3b82f6;
   --neutral-light: #1e3a5f;

   /* Component System Variables - ORIGIN UI */
   --component-border-color: #3f3f46;
   --component-border-focus: #52525b;
