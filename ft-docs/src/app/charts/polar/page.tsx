...
export default function PolarAreaChartsPage() {
  return <ChartPage title="Polar Area Charts" description="Display multi-dimensional data in a radial format. Each segment extends from the center with length proportional to its value, making it easy to compare magnitudes across categories." variants={polarAreaChartVariants} />
}
