...
export default function BubbleChartsPage() {
  return <ChartPage title="Bubble Charts" description="Display three dimensions of data with bubble charts. The x and y axes show position, while the bubble size represents a third variable." variants={bubbleChartVariants} />
}
