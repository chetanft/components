...
export default function GaugeChartsPage() {
  return <ChartPage title="Gauge Charts" description="Display single metrics in a speedometer-style visualization. Gauge charts are ideal for showing KPIs, percentages, and progress toward a goal." variants={gaugeChartVariants} />
}
