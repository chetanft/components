...
Generated: 2026-03-04T01:56:53.877Z

## Summary

- Files with issues: 114
- Total issues: 408
- Missing direct padding: 396
...
- Line 93: `bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8`
...
- Line 95: `inline-block w-px h-[0.9em] mx-2 align-middle border-l`
...
- Line 110: `box-border content-stretch flex gap-[0.625rem] items-center pb-0 pt-[0.125rem] px-0 relative shrink-0`
...
- Line 21: `flex h-10 w-full items-center justify-between rounded-md border border-[var(--border-primary)] bg-[var(--bg-primary)] px-3 py-2 text-sm-rem ring-offset-background placeholder:text-[var(--tertiary)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50`
...
- Line 120: `relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm-rem outline-none focus:bg-[var(--bg-secondary)] focus:text-[var(--primary)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50`
- Line 143: `-mx-1 my-1 h-px bg-[var(--border-secondary)]`
...
- Line 171: `pt-2 border-t border-[var(--border-secondary)]`
- Line 138: `relative border border-[var(--border-primary)] rounded cursor-pointer flex items-center gap-2 p-1 bg-[var(--color-bg-primary)] hover:border-[var(--primary)] transition-colors`
...
- Line 794: `w-full px-4 py-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg`
...
- Line 1042: `absolute top-full left-0 mt-1 px-2 py-1 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded text-xs text-red-600 dark:text-red-400 z-10`
...
- Line 94: `bg-[var(--danger)] text-[var(--color-bg-primary)] text-xs font-bold px-1.5 rounded-full min-w-[1.25rem] h-5 flex items-center justify-center border-2 border-[var(--color-bg-primary)]`
...
- Line 218: `w-px h-6 bg-[var(--overlay-control-divider)] mx-2`
- Line 237: `w-px h-6 bg-[var(--overlay-control-divider)] mx-2`
...
- Line 51: `absolute w-0 h-0 border-[0.375rem]`
...
- Line 213: `text-[var(--color-bg-primary)] text-[0.625rem] font-medium leading-none text-center`
...
- Line 27: `-mx-1 my-1 h-px bg-[var(--border-primary)]`
...
- Line 232: `bg-[var(--bg-primary)] rounded-full p-4 flex items-center justify-center w-[3.375rem] h-[3.375rem]`
- Line 314: `bg-[var(--bg-primary)] rounded-full p-4 flex items-center justify-center w-10 h-10`
- Line 494: `bg-[var(--bg-primary)] rounded-full p-4 flex items-center justify-center w-8 h-8`
- Line 555: `bg-[var(--bg-primary)] rounded-full p-4 flex items-center justify-center w-[3.375rem] h-[3.375rem]`
...
- Line 64: `box-border flex flex-1 gap-[var(--x1)] h-[var(--component-height-md)] items-center min-h-px min-w-px px-[var(--x0)] py-[var(--x5)] relative rounded-[var(--radius-md)] shrink-0`
...
- Line 32: `box-border flex gap-[var(--x2)] h-[var(--component-height-md)] items-center justify-center px-[var(--x0)] py-[var(--x5)] relative rounded-[var(--radius-md)] shrink-0`
- Line 59: `box-border flex gap-[var(--x2)] h-[var(--component-height-md)] items-center justify-center px-[var(--x0)] py-[var(--x5)] relative rounded-[var(--radius-md)] shrink-0`
...
- Line 155: `box-border flex flex-1 font-normal gap-[var(--x1)] h-[var(--component-height-md)] items-center leading-[1.4] min-h-px min-w-px px-[var(--x0)] py-[var(--x5)] relative rounded-[var(--radius-md)] shrink-0 justify-end`
...
- Line 174: `box-border flex flex-1 gap-[var(--x1)] h-[var(--component-height-md)] items-center min-h-px min-w-px px-[var(--x0)] py-[var(--x5)] relative rounded-[var(--radius-md)] shrink-0`
...
- Line 151: `box-border flex flex-1 gap-[var(--x1)] h-[var(--component-height-md)] items-center min-h-px min-w-px px-[var(--x0)] py-[var(--x5)] relative rounded-[var(--radius-md)] shrink-0`
...
- Line 182: `flex items-center justify-between px-6 py-4 border-b flex-shrink-0`
...
- Line 59: `rounded-full border border-[var(--border-primary)] p-[0.625rem] bg-[var(--bg-primary)] hover:bg-[var(--border-secondary)] transition`
