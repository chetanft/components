...
```jsx
import { AppHeader, Button, UserProfile, Footer } from 'ft-design-system';
...
```jsx
import { AppHeader } from 'ft-design-system';
...
```jsx
import { UserProfile } from 'ft-design-system';
...
```jsx
import { Footer } from 'ft-design-system';
...
```jsx
import { Empty, EmptyPresets } from 'ft-design-system';
import { Button } from 'ft-design-system';
...
import { Typography, Dropdown, DatePicker, Button } from 'ft-design-system';
...
```tsx
import type { AppHeaderProps, ButtonProps } from 'ft-design-system';
